...
class Character2(object):
    ...
    def setUpEnemies(self):
        ...
        self.e1NP.setPos(self.models.box6.getX(), self.models.box6.getY(), self.models.box6.getZ()+3)
        ...
        self.e2NP.setPos( self.models.Cylinder1.getX(), self.models.Cylinder1.getY(), self.models.Cylinder1.getZ()+3)
        ...
        self.e3NP.setPos( self.models.Cylinder2.getX(), self.models.Cylinder2.getY(), self.models.Cylinder2.getZ()+3)
        ...
        self.e4NP.setPos( self.models.Cylinder3.getX(), self.models.Cylinder3.getY(),self.models.Cylinder3.getZ()+3)
    ...
    def youLost(self):
        ...
        if (self.health < 1 or self.characterNP.getZ() < 90 ) and self.lost == 0:
    ...
    def updateEndPoint(self, task):
        ...
        if self.models.npEnd.is_empty() == False and self.models.endpoint.is_empty() == False and self.won == 0:
                ...
                if self.testWithSingleBody(self.models.nodeEnd)==True:
                    ...
                    self.b2 = DirectButton(text = "Restart", scale=.07, command=self.setRestart, pos=(0.3,0,-0.3),text_shadow =(0,0,0,0.9), text_bg=(0, 0, 0, 1),text_fg = (1,1,1,1))
                    self.b3 = DirectButton(text = "Go To Level 1", scale=.07, command=self.nextLevel1, pos=(0,0,-0.5),text_shadow =(0,0,0,0.9), text_bg=(0, 0, 0, 1),text_fg = (1,1,1,1))
